(function (global) {
  ...
  define("ember-data/system/model/model", [
    ...
    var JSONSerializer;
    var retrieveFromCurrentState = Ember.computed(
      "currentState",
      function (key, value) {
        ...
        if (!this.members.has(record)) {
          ...
          if (this.inverseKey) {
            ...
            if (!record._implicitRelationships[this.inverseKeyForImplicit]) {
              record._implicitRelationships[this.inverseKeyForImplicit] =
                new Relationship(this.store, record, this.key, { options: {} });
            }
